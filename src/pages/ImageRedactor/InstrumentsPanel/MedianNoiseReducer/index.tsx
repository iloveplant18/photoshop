...
import useMedianNoiseReducer from "./hooks/useMedianNoiseReducer";

function MedianNoiseReducer() {
  const applyMedianNoiseReducer = useMedianNoiseReducer();

  return (
    <div className="tooltip tooltip-primary" data-tip="Медианный шумодав">
      <IconButton
        onClick={() => {
          applyMedianNoiseReducer();
        }}
      >
        <svg
          width="25px"
        ...
        >
          ...
          <rect
            ...
            width="2"
            height="2"
            transform="translate(14 20) rotate(-90)"
